        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (dbHelper.validarUsuario(username, password)) { // Usar la base de datos para validar
                    ...
                    Toast.makeText(Intro.this, "¡Bienvenido!", Toast.LENGTH_SHORT).show();
                    // Navegar a la actividad principal
                    Intent intent = new Intent(Intro.this, MainActivity4.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(Intro.this, "Usuario o contraseña incorrectos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        registerButton.setOnClickListener(v -> {
            ...
            if (!username.isEmpty() && !password.isEmpty()) {
                if (dbHelper.insertarUsuario(username, password)) {
                    Toast.makeText(Intro.this, "Usuario registrado con éxito.", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                } else {
                    Toast.makeText(Intro.this, "El usuario ya existe.", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(Intro.this, "Por favor, completa todos los campos.", Toast.LENGTH_SHORT).show();
            }
        });
